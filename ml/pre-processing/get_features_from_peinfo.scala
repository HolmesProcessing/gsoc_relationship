...
case class peinfo_int_final_seq_rdd_class(sha256: String, peinfo_int_seq_results: Array[Double])
...
peinfo_binaray_final_array_rdd.toDF().write.format("parquet").save("./peinfo_binaray_final_array.parquet")
